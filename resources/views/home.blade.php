        ...
        <div class="row display-table-row">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    ...
                    <h2>Pending (Unseen)</h2>

                        <ul class="list-group">
                      @foreach ($revisions as $revision)
                          @if (!$revision->seen)
                            <li class="list-group-item"><a href="{{ action('RevisionController@show', [$revision->id]) }}">{{ $revision->user->name}} has made edits to {{ $revision->title }} on the {{ $revision->created_at }}</a>
                            <div class="pull-right"><button class="btn btn-xs btn-primary">Aprove</button> <button class="btn btn-xs btn-danger">Decline</button></div>
                            </li>
                         @endif
                      @endforeach
                    </ul>
                    ...
                    <h2>Declined</h2>
                        ...
                        <ul class="list-group">
                      @foreach ($revisions as $revision)
                          @if ($revision->seen && !$revision->approved)
                            <li class="list-group-item"><a href="{{ action('RevisionController@show', [$revision->id]) }}">{{ $revision->user->name}} has made edits to {{ $revision->title }} on the {{ $revision->created_at }}</a>
                            <div class="pull-right"><button class="btn btn-xs btn-primary">Aprove</button> <button class="btn btn-xs btn-danger">Decline</button></div>
                            </li>
                         @endif
